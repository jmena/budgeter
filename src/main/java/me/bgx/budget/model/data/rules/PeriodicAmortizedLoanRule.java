...
import me.bgx.budget.model.generators.PeriodicAmortizedLoanGenerator;
...
@IsRule(type = "monthly-amortized-loan", label = "Monthly amortized loan", generator = PeriodicAmortizedLoanGenerator.class)
public class PeriodicAmortizedLoanRule extends Rule {
